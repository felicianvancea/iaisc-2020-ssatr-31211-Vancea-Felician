...
public class GraphWindow {
	...
	private final String[] ALGORITHMS = {"PID32", "CAAPID32", "CAAPID16", "FuzzyLogic"};
	...
	private JPanel createAlgorithmPanel() {
		...
		algorithmParamsPanel.add(createFuzzyPanel(), "FuzzyLogic");
	...
	private XYDataset generateDataset() {
		...
		}else if("FuzzyLogic".equals(algo)) {
	...
	private JPanel createSliderPanel(String labelText, double initialValue, int min, int max, final ValueChangedAction action) {
		return createSliderPanel(labelText, initialValue, min, max, 1, action);
	}
	
	private JPanel createSliderPanel(String labelText, double initialValue, int min, int max, final int divisor, final ValueChangedAction action) {
